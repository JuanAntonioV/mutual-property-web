            ...
            <MainContainer className='mt-[100px]'>
                    ...
                    <div className='flex-col order-2 pt-16 flexCenter lg:order-1 md:pt-0'>
                        <div className='space-y-6 text-center md:text-left'>
                            <h1 className='text-3xl font-bold'>
                                <span className='text-4xl'>👋</span> Tentang
                                Kami
                            </h1>
                            <p className='md:text-lg w-full md:w-[600px] text-gray-600'>
                                Mutual Property adalah platform untuk membeli,
                                menjual, atau bahkan menyewakan properti Anda
                                dengan mudah dan terpercaya. Kami menyediakan
                                berbagai macam properti yang dapat Anda pilih
                                sesuai dengan kebutuhan Anda. Kami juga
                                menyediakan layanan titip jual properti Anda
                                dengan komisi yang sangat terjangkau.
                            </p>
                        </div>
                    </div>
                ...
                <section className='py-20 space-y-6'>
                    ...
                    <p className='md:text-lg text-center mx-auto w-full md:w-[800px] text-gray-600'>
                        Mutual Property memiliki visi untuk menjadi platform
                        yang dapat memberikan kemudahan bagi masyarakat dalam
                        membeli, menjual, atau menyewakan properti. Kami juga
                        memiliki misi untuk menjadi platform yang dapat
                        memberikan keuntungan bagi masyarakat dalam bertransaksi
                        properti.
                    </p>
                </section>
                    ...
                    <section className='py-10 space-y-10'>
                        <header className='space-y-1'>
                            ...
                            <p className='w-full text-center text-secondary md:text-lg'>
                                Hubungi kami sekarang juga dengan mengisi form
                                dibawah ini.
                            </p>
                        </header>
                                ...
                                <form className='space-y-6'>
                                    ...
                                    <div>
                                        <p className='mt-4 text-xs text-gray-500'>
                                            ...
                                            email yang Anda berikan. Kami tidak
                                            akan membagikan informasi Anda
                                            kepada pihak ketiga.
                                        </p>
                                    </div>
                                </form>
                                ...
                                <div className='lg:w-[320px] h-[400px] flexBetween flex-col items-start bg-white rounded-xl border border-borderPrimary p-8'>
                                    ...
                                    <main className='py-10'>
                                        <p className={'text-gray-600'}>
                                            I want thank you for creating such
                                            an amazing platform which has the
                                            capability to help new entrepreneurs
                                            like me to take their product to
                                            next level. Thank you for helping me
                                            & supporting me during the entire
                                            journey.
                                        </p>
                                    </main>
